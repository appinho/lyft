...
def optimize2(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    # your class weights
    classes_weights = tf.constant([[1.0, 1.0, 1.0]])
    ...
    # 2
    # cross_entropy_loss =
    # tf.nn.weighted_cross_entropy_with_logits(logits=logits, targets=labels,
    # pos_weight=classes_weights)    # Define optimizer
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    for epoch in range(epochs):
        ...
        save_path = saver.save(sess, "./tmp/model" + str(epoch) + ".ckpt")
